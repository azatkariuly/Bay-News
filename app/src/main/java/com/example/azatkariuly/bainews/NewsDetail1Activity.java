...
public class NewsDetail1Activity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
...
//            databaseBook.child(encodeChild(mTitle)).setValue(newsDesc);
            databaseBook.child(encodeUserEmail(encodeChild(mTitle))).removeValue();
